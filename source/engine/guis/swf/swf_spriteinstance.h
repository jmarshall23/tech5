...
public:
	...
	void	Init( idSWFSprite * sprite, idSWFSpriteInstance * parent, const char * name, int depth );
	...
	swfDisplayEntry_t * ExecutePlaceObject2( const placeObject2Data_t & po2 );
	...
	swfDisplayEntry_t *		AddDisplayEntry( int depth, int characterID, const idStr & objectName );
...
#define SWF_SPRITE_FUNCTION_DECLARE( x ) \
	...
	SWF_NATIVE_VAR_DECLARE( _followBorder );
