...
public:
	...
	void Init( idSWFEditText * editText, idSWFSpriteInstance * parent, const char * name, int depth, idSWF * swf );
	void ReInit();
	...
	const idStr & GetSoundClip() const { return soundClip; }
	...
	const idStr & GetSpeaker() const { return subSpeaker; }
...
#define SWF_TEXT_FUNCTION_DECLARE( x ) \
	...
	SWF_NATIVE_VAR_DECLARE( tooltipBindset );
