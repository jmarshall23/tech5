...
public:
	...
	void SetSerializerLog( idSerializerLog * log );
	idSerializerLog * GetSerializerLog() const { return serializeLog; }
...
static_assert( sizeof( idSnapShot::objectBuffer_t ) == 8, "Recovered snapshot buffer ABI changed" );
static_assert( sizeof( idSnapShot::objectState_t ) == 32, "Recovered snapshot state ABI changed" );
static_assert( sizeof( idSnapShot ) == 52, "Recovered idSnapShot ABI changed" );
#endif
