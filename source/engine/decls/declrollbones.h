...
// Original PDB header: w:\tech5\engine\decls\declrollbones.h
// Recovered logical types: 3
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 16695; PDB kind: class.
class idDeclRollBones::idDeclRollBoneInstance
{
public:
...
// IDA Local Type ordinal 16697; PDB kind: class.
class idDeclRollBones : public idDeclTypeInfo
{
public:
  // Recovered virtual interface; IDA vtable ordinal 16698.
  virtual ~idDeclRollBones();
  ...
  idList<idDeclRollBones::idDeclRollBoneInstance,5> rollBones;
};

// IDA Local Type ordinal 20084; PDB kind: class.
class __declspec(align(8)) idTestRollBones : public idAnimatedEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 20085.
  virtual idTypeInfo *GetType();
  virtual ~idTestRollBones();
  ...
  idStrAnimName nameBaseTrack;
  bool useDualQuatSkinning;
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> baseTrackAlias;
  idAnimator_Channel animatorBaseTrack;
  idAnimator_RollBones animatorRollBones;
};
