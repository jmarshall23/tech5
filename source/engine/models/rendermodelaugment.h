...
// Original PDB header: w:\tech5\engine\models\rendermodelaugment.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 15388; PDB kind: class.
class idRenderModelAugmentOutline : public idRenderModel
{
public:
  // Recovered virtual interface; IDA vtable ordinal 15389.
  ...
  virtual ~idRenderModelAugmentOutline();
