...
// Original PDB header: w:\tech5\engine\models\foliage\rendermodelfoliageedit.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 13588; PDB kind: class.
class __declspec(align(16)) idRenderModelFoliageEdit : public idRenderModel
{
public:
  // Recovered virtual interface; IDA vtable ordinal 13589.
  ...
  virtual ~idRenderModelFoliageEdit();
