...
int64			Sys_GetClockTicks();
int64			Sys_ClockTicksPerSecond();
...
#if defined( TECH5_LEGACY_SYS_NETWORKING )
typedef enum {
...
public:
	virtual			~idKeyboard() { }
	virtual int		PollInputEvents() { return 0; }
	virtual int		ReturnInputEvent( const int n, int & key, bool & state ) { return 0; }
	virtual void	EndInputEvents() { }
};
...
public:
	virtual				~idSys() { }
	virtual int64			GetClockTicks() = 0;
	virtual int64			ClockTicksPerSecond() = 0;
	...
	virtual uint32			DLL_Load( const char *dllName ) = 0;
	virtual void *			DLL_GetProcAddress( uint32 dllHandle, const char *procName ) = 0;
	virtual void			DLL_Unload( uint32 dllHandle ) = 0;
	virtual void			DLL_GetFileName( const char *baseName, char *dllName, int maxLength ) = 0;
	virtual void			OpenURL( const char *url, bool quit ) = 0;
	virtual void			StartProcess( const char *exePath, bool quit ) = 0;
	virtual const char *	GetClipboardData() = 0;
	virtual void			SetClipboardData( const char * text ) = 0;
	virtual int				Milliseconds() = 0;
	virtual uint32			VblCount() = 0;
	virtual void			PrintStackTrace() = 0;
	virtual idJoystick &	Joystick() = 0;
	virtual idKeyboard &	Keyboard() = 0;
	virtual idMouse &		Mouse() = 0;
	virtual const char *	GetOSUserName() = 0;
	virtual const char *	GetMachineName() = 0;
	virtual void			QueueEvent( sysEventType_t type, int value, int value2,
								int ptrLength, void * ptr, int inputDeviceNum ) = 0;
