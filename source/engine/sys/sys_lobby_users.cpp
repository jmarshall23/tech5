...
lobbyUser_t idLobby::CreateLobbyUserFromLocalUser( const idLocalUser * localUser ) {
	...
	strncpy_s( lobbyUser.gamertag, sizeof( lobbyUser.gamertag ), localUser->GetGamerTag(), _TRUNCATE );
...
lobbyUserID_t idLobby::AllocLobbyUserSlotForBot( const char * botName ) {
	...
	strncpy_s( botSessionUser.gamertag, sizeof( botSessionUser.gamertag ), botName, _TRUNCATE );
