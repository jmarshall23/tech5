...
public:
	...
	void	Clear();
	bool	operator==( const idSaveGameDetails & other ) const { return ( _stricmp( slotName.c_str(), other.slotName.c_str() ) == 0 ); }
	...
	int		GetPlaytime() const { int value = 0; descriptors.GetInt( SAVEGAME_DETAIL_FIELD_PLAYTIME, 0, value ); return value; }
	int		GetExpansion() const { int value = 0; descriptors.GetInt( SAVEGAME_DETAIL_FIELD_EXPANSION, 0, value ); return value; }
	int		GetDifficulty() const { int value = -1; descriptors.GetInt( SAVEGAME_DETAIL_FIELD_DIFFICULTY, -1, value ); return value; }
	int		GetSaveVersion() const { int value = 0; descriptors.GetInt( SAVEGAME_DETAIL_FIELD_SAVE_VERSION, 0, value ); return value; }
