...
// Original PDB header: w:\tech5\engine\gamelib\animstack\animator_vehiclecar.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 14564; PDB kind: class.
class __declspec(align(4)) idAnimator_VehicleCar : public idAnimator_Base
{
public:
  // Recovered virtual interface; IDA vtable ordinal 14565.
  virtual ~idAnimator_VehicleCar();
  ...
  idIndex<short,enum invalidJointIndex_t> steeringWheelJoint;
