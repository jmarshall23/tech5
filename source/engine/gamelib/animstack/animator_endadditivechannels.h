...
// Original PDB header: w:\tech5\engine\gamelib\animstack\animator_endadditivechannels.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 14643; PDB kind: class.
class idAnimator_EndAdditiveChannels : public idAnimator_Base
{
public:
  // Recovered virtual interface; IDA vtable ordinal 14644.
  virtual ~idAnimator_EndAdditiveChannels();
  ...
  idList<idHandle<unsigned short,enum invalidAliasHandle_t,65535>,5> animAlias;
...
// IDA Local Type ordinal 18909; PDB kind: class.
