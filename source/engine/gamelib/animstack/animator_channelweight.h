...
// Original PDB header: w:\tech5\engine\gamelib\animstack\animator_channelweight.h
// Recovered logical types: 3
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 15089; PDB kind: class.
class idAnimator_ChannelWeight::baseAnimation_t
{
public:
...
// IDA Local Type ordinal 15090; PDB kind: class.
class idAnimator_ChannelWeight::leafAnimation_t : public idAnimator_ChannelWeight::baseAnimation_t
{
public:
  idMD6Branch *branch;
};

// IDA Local Type ordinal 15092; PDB kind: class.
class idAnimator_ChannelWeight : public idAnimator_Base
{
public:
  // Recovered virtual interface; IDA vtable ordinal 15093.
  virtual ~idAnimator_ChannelWeight();
  ...
  idList<idAnimator_ChannelWeight::leafAnimation_t,5> leaves;
  idAnimator_ChannelWeight::baseAnimation_t baseAnimation;
