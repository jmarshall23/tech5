...
// Original PDB header: w:\tech5\engine\gamelib\physics\physics_simple_dynamic.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 22316; PDB kind: struct.
struct idPhysics_Simple_Dynamic::physicsSimpleDynamicData_t
{
  idVec3 origin;
  idMat3 axis;
...
// IDA Local Type ordinal 22317; PDB kind: class.
class idPhysics_Simple_Dynamic : public idPhysics_DynamicBase
{
public:
  // Recovered virtual interface; IDA vtable ordinal 22318.
  virtual ~idPhysics_Simple_Dynamic();
  ...
  idPhysics_Simple_Dynamic::physicsSimpleDynamicData_t previous;
  idPhysics_Simple_Dynamic::physicsSimpleDynamicData_t current;
