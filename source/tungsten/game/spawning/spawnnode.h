...
// Original PDB header: w:\tech5\tungsten\game\spawning\spawnnode.h
// Recovered logical types: 6
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1133; PDB kind: enum.
enum idSpawnNode::nodeType_t : __int32
{
  TYPE_STANDARD = 0x0,
};

// IDA Local Type ordinal 1134; PDB kind: enum.
enum idSpawnNode::debugDrawLevel_t : __int32
{
  DL_NONE = 0x0,
  DL_LOW = 0x1,
  DL_HIGH = 0x2,
...
// IDA Local Type ordinal 15570; PDB kind: class.
class __declspec(align(8)) idSpawnNode : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 15571.
  ...
  idSpawnNode::nodeType_t nodeType;
  gameTeam_t team;
  bool isActive;
  bool initial;
};

// IDA Local Type ordinal 17615; PDB kind: class.
class __declspec(align(8)) idSpawnNodeSplines : public idSpawnNode
{
public:
  // Recovered virtual interface; IDA vtable ordinal 17616.
  virtual idTypeInfo *GetType();
  virtual ~idSpawnNodeSplines();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
  ...
  idList<idEntityPtr<idSplinePath>,5> splinePaths;
  idList<idCurve_Spline<idVec3> *,5> splineCurves;
  int totalLocationCount;
};

// IDA Local Type ordinal 22281; PDB kind: struct.
struct idSpawnNode::actorFilterFlags_t
{
  bool player;
};

// IDA Local Type ordinal 33004; PDB kind: typedef.
typedef idList<idSpawnNode *,5> SpawnNodeList;
