...
// Original PDB header: w:\tech5\tungsten\game\entities\dropship.h
// Recovered logical types: 4
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1947; PDB kind: enum.
enum dropShipState_t : __int32
{
  DPSP_HOVER = 0x0,
  DPSP_ENROUTE = 0x1,
  DPSP_DROPCARGO = 0x2,
  DPSP_WAITTILLCLEAR = 0x3,
  DPSP_HEADINGOUT = 0x4,
  DPSP_POWERDOWN = 0x5,
  DPSP_LANDED = 0x6,
  DPSP_DONE = 0x7,
...
// IDA Local Type ordinal 19941; PDB kind: struct.
struct __declspec(align(4)) dropShipCargo_t
{
  idEntityPtr<idTarget_Spawn> targetSpawn;
  const idDeclEntityDef *cargoDef;
  int count;
  bool waitTillClear;
};

// IDA Local Type ordinal 19945; PDB kind: struct.
struct idDropShip::dropShipSound_t
{
...
// IDA Local Type ordinal 19947; PDB kind: class.
class __declspec(align(8)) idDropShip : public idAnimatedEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19948.
  ...
  idInventoryAttachmentDef jetPack;
  ...
  idList<idDropShip::dropShipSound_t,5> dropShipSound;
  float soundFadeTime;
  idList<idEntityPtr<idAI2>,5> droppedCargo;
  idInventoryCollection inventory;
  idWeapon *weapon;
  idCurve_Spline<idVec3> *currentSpline;
  int currentSplineIdx;
  idSpring<idVec3> movementSpring;
  idMat3 currentAxis;
  idAngles angles;
  float currentDt;
