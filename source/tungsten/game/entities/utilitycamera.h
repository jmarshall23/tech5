...
// Original PDB header: w:\tech5\tungsten\game\entities\utilitycamera.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 14759; PDB kind: class.
class __declspec(align(8)) idUtilityCamera : public idCamera
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34062.
  virtual idTypeInfo *GetType();
  virtual ~idUtilityCamera();
  ...
  idVec3 cachedViewOrg;
  idMat3 cachedViewAxis;
};

// IDA Local Type ordinal 14760; PDB kind: class.
class idEntityCamera : public idUtilityCamera
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34112.
  virtual idTypeInfo *GetType();
  virtual ~idEntityCamera();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
