...
// Original PDB header: w:\tech5\tungsten\game\entities\door_base.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1709; PDB kind: enum.
enum idDoor_Base::doorState_t : __int32
{
  DOOR_UNKNOWN = 0x0,
  DOOR_CLOSING = 0x1,
  DOOR_CLOSED = 0x2,
...
// IDA Local Type ordinal 19028; PDB kind: class.
class idDoor_Base : public idAnimatedEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19031.
  ...
  bool removeKeyOnUse;
  const idSoundShader *locked_sound;
  const idSoundShader *unlock_sound;
  const idDeclAiEvent *motionEventDecl;
  idList<idEntityPtr<idEntity>,5> linked;
  idSoundDoor *soundDoor;
  float kicked;
  idDoor_Base::doorState_t state;
  idBounds bounds;
};
