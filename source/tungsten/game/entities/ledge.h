...
// Original PDB header: w:\tech5\tungsten\game\entities\ledge.h
// Recovered logical types: 7
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1253; PDB kind: enum.
enum idLedge::ledgeEdgeType_t : __int32
{
  EDGETYPE_NONE = 0x0,
  EDGETYPE_LEFTEDGE = 0x1,
  EDGETYPE_RIGHTEDGE = 0x2,
  EDGETYPE_LEFTEDGE_HASTURN = 0x3,
  EDGETYPE_RIGHTEDGE_HASTURN = 0x4,
};

// IDA Local Type ordinal 1254; PDB kind: enum.
enum idLedge::ledgeType_t : __int32
{
  LEDGETYPE_CLOCKWISE = 0x0,
  LEDGETYPE_ANTICLOCKWISE = 0x1,
};

// IDA Local Type ordinal 1255; PDB kind: enum.
enum idLedge::ledgeBitFlags_t : __int32
{
  CONNECTED_NONE = 0x0,
  CONNECTED_FIRST_90_INLEFT = 0x1,
  CONNECTED_FIRST_90_OUTLEFT = 0x2,
  CONNECTED_FIRST_90_INRIGHT = 0x4,
  CONNECTED_FIRST_90_OUTRIGHT = 0x8,
...
// IDA Local Type ordinal 17961; PDB kind: class.
class idLedge::idLedgeBit
{
public:
  idVec3 firstPoint;
  idVec3 secondPoint;
...
// IDA Local Type ordinal 17963; PDB kind: class.
class __declspec(align(8)) idLedge : public idSplinePath
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34114.
  ...
  idList<idLedge::idLedgeBit,5> ledgeBits;
  idLedge::ledgeType_t ledgeNormalHint;
  float maxDeltaYaw;
  float maxDeltaPitch;
};

// IDA Local Type ordinal 17966; PDB kind: class.
class idUseLedge : public idUse
{
public:
  // Recovered virtual interface; IDA vtable ordinal 17967.
  virtual idTypeInfo *GetType();
  virtual ~idUseLedge();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  ...
  idPlayer::idPlayerBehaviorContextualShimmyState_t mountType;
  idEntityPtr<idEntity> targetPositionEntity;
  idEntityPtr<idEntity> endPositionEntity;
  idAnimAliasRef customLegsAnimation;
  idAnimAliasRef customHandsAnimation;
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> customLegsAnimationHandle;
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> customHandsAnimationHandle;
};

// IDA Local Type ordinal 22817; PDB kind: struct.
struct silEdge_t
{
  float length;
  int t1;
