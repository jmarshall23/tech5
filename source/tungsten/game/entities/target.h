...
// Original PDB header: w:\tech5\tungsten\game\entities\target.h
// Recovered logical types: 8
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1774; PDB kind: enum.
enum idTarget_Job::targetJob_t : __int32
{
  TARGETJOB_ACCEPTED = 0x0,
  TARGETJOB_READYTOTURNIN = 0x1,
  TARGETJOB_COMPLETED = 0x2,
  TARGETJOB_FAILED = 0x3,
};

// IDA Local Type ordinal 1788; PDB kind: enum.
enum idTarget_Door::setting_t : __int32
{
  SET_FALSE = 0x0,
  SET_TRUE = 0x1,
  KEEP = 0x2,
...
// IDA Local Type ordinal 2425; PDB kind: enum.
enum progTarget_t : __int32
{
  PT_PC = 0x0,
  PT_PC_D3D = 0x1,
  PT_360 = 0x2,
...
// IDA Local Type ordinal 19236; PDB kind: class.
class idTarget_Door : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19237.
  virtual idTypeInfo *GetType();
  virtual ~idTarget_Door();
  ...
  idTarget_Door::setting_t playerUsable;
  idTarget_Door::setting_t forceUnusable;
  idTarget_Door::setting_t open;
  idTarget_Door::setting_t locked;
};

// IDA Local Type ordinal 19378; PDB kind: class.
class __declspec(align(8)) idTarget_Show : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19379.
  virtual idTypeInfo *GetType();
  virtual ~idTarget_Show();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
...
// IDA Local Type ordinal 19384; PDB kind: class.
class __declspec(align(8)) idTarget_Use : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19385.
  virtual idTypeInfo *GetType();
  virtual ~idTarget_Use();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
...
// IDA Local Type ordinal 19386; PDB kind: class.
class __declspec(align(8)) idTarget_Job : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19387.
  virtual idTypeInfo *GetType();
  virtual ~idTarget_Job();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
  ...
  bool completeTree;
  bool giveJob;
  bool markGivenJobUnknown;
  bool treatAsDebug;
  bool HACK_noitemrewards;
  bool HACK_nolayerchanges;
  bool clearJobNotesForThisJob;
  idTarget_Job::targetJob_t action;
  bool playerOnly;
  const idDeclJobNote *jobNoteOverride;
  bool clearJobStateFirst;
  bool activateCinematicCam;
};

// IDA Local Type ordinal 23643; PDB kind: struct.
struct genTarget_t
{
  char mapName[128];
  char virtualTextureMaterialName[64];
  int virtualTexelsWide;
};
