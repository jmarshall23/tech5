...
// Original PDB header: w:\tech5\tungsten\game\entities\door_laser.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19955; PDB kind: class.
class idDoor_Laser::idDoor_LaserBar
{
public:
  int behavior;
  idVec3 startRelativePosition;
  idVec3 endRelativePosition;
  float openDelay;
  float openSpeed;
  float closeDelay;
  float closeSpeed;
  ...
  idVec3 endPosition;
  float openPercent[2];
  idClipQuery clipQuery[2];
  int startOpenCloseTime;
  int nextSparkTime;
};

// IDA Local Type ordinal 19957; PDB kind: class.
class __declspec(align(4)) idDoor_Laser : public idVolume
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34111.
  ...
  float barSize;
  idList<idDeclParticle const *,5> sparkParticles;
  float sparkDelayMin;
  float sparkDelayMax;
  float barOpenExtraPercent;
  float sparkBackExtraPercent;
  idList<idDoor_Laser::idDoor_LaserBar,5> bars;
