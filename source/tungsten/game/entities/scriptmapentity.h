...
// Original PDB header: w:\tech5\tungsten\game\entities\scriptmapentity.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19491; PDB kind: class.
class idScriptMapEntity : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19492.
  virtual idTypeInfo *GetType();
  virtual ~idScriptMapEntity();
