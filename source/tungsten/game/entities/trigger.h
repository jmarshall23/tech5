...
// Original PDB header: w:\tech5\tungsten\game\entities\trigger.h
// Recovered logical types: 3
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 15547; PDB kind: class.
class idTrigger : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 15548.
  ...
  idStr call;
  idStr userData;
  idEntityPtr<idEntity> entityCanActivate;
  bool playerCanActivate;
  bool playerVehicleCanActivate;
  bool vehicleOccupantCanActivate;
  bool anyVehicleCanActivate;
  bool aiCanActivate;
  bool turretCanActivate;
  int nextTriggerTime;
  int extraContents;
};

// IDA Local Type ordinal 19068; PDB kind: class.
class idTrigger_Exit : public idTrigger
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19069.
  virtual idTypeInfo *GetType();
  virtual ~idTrigger_Exit();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
...
// IDA Local Type ordinal 21818; PDB kind: class.
class idSoundTrigger : public idTrigger
{
public:
  // Recovered virtual interface; IDA vtable ordinal 21819.
  virtual idTypeInfo *GetType();
  virtual ~idSoundTrigger();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
