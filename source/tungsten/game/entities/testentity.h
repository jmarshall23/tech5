...
// Original PDB header: w:\tech5\tungsten\game\entities\testentity.h
// Recovered logical types: 4
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 16023; PDB kind: struct.
struct idTestEntity::testFlags_t
{
  unsigned __int8 : 2;
  __int8 flag6 : 1;
  __int8 flag5 : 1;
...
// IDA Local Type ordinal 16026; PDB kind: struct.
struct idTestEntity::test_t
{
  idVec3 vector;
  idAngles angles;
};

// IDA Local Type ordinal 16028; PDB kind: class.
class idTestEntity : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 16029.
  virtual idTypeInfo *GetType();
  virtual ~idTestEntity();
  ...
  float float_;
  long double double_;
  idBoundedInt<0,4> boundedInt;
  idBoundedFloat<0,0,1,0> boundedFloat;
  idVec2 vec2;
  idVec3 vec3;
  idVec4 vec4;
  idMat3 mat3;
  idAngles angles;
  testEnum_t enum_;
  idTestEntity::testFlags_t testFlags;
  idStr string;
  idColor color;
  ...
  const idDeclEntityDef *testEntityDef;
  const idDeclFX *fx;
  const idDeclParticle *particle;
  const idDeclAF *af;
  const idDeclRenderParm *renderParm;
  const idDeclRenderProg *renderProg;
  const idDeclDamage *damageDef;
  const idDeclInventory *inventoryDef;
  const idDeclWeapon *weaponDef;
  const idDeclProjectile *projectileDef;
  idEntityPtr<idEntity> otherEntity;
  int intArray[10];
  idList<int,5> intList;
  idList<idStr,5> strList;
  idList<idSoundShader const *,5> soundList;
  idList<idSpawnRenderParm,5> spawnRenderParmBlock;
  idSpawnRenderParm spawnRenderParmArray[10];
  idList<idTestEntity::test_t,5> structList;
  int test1;
  float test2;
  idVec3 test3;
};

// IDA Local Type ordinal 19135; PDB kind: class.
class __declspec(align(8)) idTarget_TestEntity : public idTarget_Test
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19136.
  virtual idTypeInfo *GetType();
  virtual ~idTarget_TestEntity();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
  ...
  idEntityPtr<idEntity> testEntity;
};
