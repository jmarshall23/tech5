...
// Original PDB header: w:\tech5\tungsten\game\entities\modifiedplayermovement.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19711; PDB kind: class.
class __declspec(align(8)) idModifiedPlayerMovement : public idAnimatedSimple
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19712.
  virtual idTypeInfo *GetType();
  virtual ~idModifiedPlayerMovement();
