...
// Original PDB header: w:\tech5\tungsten\game\entities\target_player.h
// Recovered logical types: 5
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 2634; PDB kind: enum.
enum idTarget_PlayVideo::screenNumber_t : __int32
{
  VIDEO1 = 0x0,
  VIDEO2 = 0x1,
  VIDEO3 = 0x2,
...
// IDA Local Type ordinal 19228; PDB kind: class.
class idTarget_PlayVideo : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19229.
  virtual idTypeInfo *GetType();
  virtual ~idTarget_PlayVideo();
  ...
  idTarget_PlayVideo::screenNumber_t screenNumber;
  int timeOffset;
  bool looping;
  bool paused;
  bool startOn;
...
// IDA Local Type ordinal 19250; PDB kind: class.
class __declspec(align(4)) idTarget_PlayVoiceOver : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19251.
  virtual idTypeInfo *GetType();
  virtual ~idTarget_PlayVoiceOver();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
...
// IDA Local Type ordinal 19294; PDB kind: class.
class idTarget_PlayerWhiplash : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19295.
  virtual idTypeInfo *GetType();
  virtual ~idTarget_PlayerWhiplash();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
...
// IDA Local Type ordinal 19341; PDB kind: class.
class __declspec(align(8)) idTarget_PlayerCrouch : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19342.
  virtual idTypeInfo *GetType();
  virtual ~idTarget_PlayerCrouch();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
