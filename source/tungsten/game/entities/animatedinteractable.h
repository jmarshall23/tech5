...
// Original PDB header: w:\tech5\tungsten\game\entities\animatedinteractable.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 20078; PDB kind: class.
class __declspec(align(4)) idAnimatedInteractable : public idAnimatedEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 20079.
  virtual idTypeInfo *GetType();
  virtual ~idAnimatedInteractable();
  ...
  idEntityPtr<idEntity> usedByEntity;
  idAnimator_Channel interactableAnimator;
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> onAnim;
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> offAnim;
  idDeclJobRef availableJobDecl;
  missionStatus_t availableJobStatus;
  idDeclJobRef notAvailableJobDecl;
  missionStatus_t notAvailableJobStatus;
  idStrId displayText;
  bool isOn;
  bool playing;
};
