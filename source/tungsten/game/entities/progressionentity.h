...
// Original PDB header: w:\tech5\tungsten\game\entities\progressionentity.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19600; PDB kind: class.
class idProgressionEntity::idProgressionParms
{
public:
  float timeAtState;
  bool changeStateInView;
  bool incrementsOnOwnerTrigger;
  bool incrementsOnMapLoad;
  idList<idDeclEntityDef const *,5> entityDefs;
  idList<idEntityPtr<idEntity>,5> entities;
  idList<idEntityPtr<idTrigger>,5> triggers;
};

// IDA Local Type ordinal 19603; PDB kind: class.
class idProgressionEntity : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19604.
  virtual idTypeInfo *GetType();
  virtual ~idProgressionEntity();
  ...
  idList<idProgressionEntity::idProgressionParms,5> progressionParms;
  int defaultState;
  bool changeStateWithinMap;
  bool forcePrespawnAll;
  bool wrappable;
  bool reusable;
  bool initiallyHideEntities;
  idList<idList<idEntity *,5>,5> spawnedEntities;
  bool preSpawnAll;
  bool waitUntilNextMapLoad;
  int spawnedState;
  idEntityRetainedState *retainedState;
};
