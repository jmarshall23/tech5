...
// Original PDB header: w:\tech5\tungsten\game\entities\testmodel2.h
// Recovered logical types: 3
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1762; PDB kind: enum.
enum idTestModel2::translation_t : __int32
{
  TRANSLATE_FIXED = 0x0,
  TRANSLATE_RESET = 0x1,
  TRANSLATE_CONTINUOUS = 0x2,
  TRANSLATE_MAX = 0x3,
};

// IDA Local Type ordinal 1763; PDB kind: enum.
enum idTestModel2::parseFlags_t : __int32
{
  PF_WRAPMODE = 0x1,
  PF_WEIGHTGROUP = 0x2,
  PF_RATE = 0x4,
...
// IDA Local Type ordinal 19150; PDB kind: class.
class __declspec(align(8)) idTestModel2 : public idAnimatedEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19151.
  virtual idTypeInfo *GetType();
  virtual ~idTestModel2();
  ...
  idAnimator_BlendEq blendEqAnimator;
  idList<idAnimator_BlendEq::idNamedAnim,5> namedAnims;
  idList<idAnimWebScalar,5> blendVariables;
  idScalarMemBlock scalarMem;
  idAnimator_Channel channelAnimator;
  idFaceMgr faceMgr;
  idMat3 resetAxis;
  idVec3 resetOrigin;
  idTestModel2::translation_t translationMode;
  idAttachmentCollection attachments;
  int curLoopCount;
  int curAliasIndex;
  float curFrame;
  idAngles rotationAngles;
  idVec3 accumulatedDeltaTrans;
  idQuat accumulatedDeltaRot;
  bool ignoreFirstDelta;
};
