...
// Original PDB header: w:\tech5\tungsten\game\entities\racespectator.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19528; PDB kind: struct.
struct idRaceSpectator::spectatorAttachment_t
{
  const idDeclInventory *inventoryItem;
  idStr tagName;
};

// IDA Local Type ordinal 19531; PDB kind: class.
class __declspec(align(8)) idRaceSpectator : public idAnimatedEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19532.
  virtual idTypeInfo *GetType();
  virtual ~idRaceSpectator();
  ...
  const idDeclAnimWeb *animWeb;
  idAnimWebPath idleAnim;
  idAnimWebPath triggerAnim;
  bool alwaysUpdate;
  idAttachmentCollection attachments;
  idAnimWebSpectator animWebAnimator;
  idStaticList<idRaceSpectator::spectatorAttachment_t,2> attachedItems;
};
