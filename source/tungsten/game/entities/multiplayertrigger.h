...
// Original PDB header: w:\tech5\tungsten\game\entities\multiplayertrigger.h
// Recovered logical types: 3
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 15440; PDB kind: class.
class idMultiplayerTriggerStrategy : public idClass
{
public:
  // Recovered virtual interface; IDA vtable ordinal 15441.
  virtual idTypeInfo *GetType();
  virtual ~idMultiplayerTriggerStrategy();
  ...
  virtual mpTriggerType_t GetTriggerType();

};

// IDA Local Type ordinal 19623; PDB kind: class.
class idMultiplayerTrigger : public idTrigger
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19624.
  virtual idTypeInfo *GetType();
  virtual ~idMultiplayerTrigger();
...
// IDA Local Type ordinal 19627; PDB kind: class.
class __declspec(align(8)) idMultiplayerTrigger_BoostPad : public idMultiplayerTrigger
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19628.
  virtual idTypeInfo *GetType();
  virtual ~idMultiplayerTrigger_BoostPad();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
  ...
  idEntityPtr<idInfo> fxInfo;
  float acceleration;
  int time;
  idMultiplayerTriggerStrategy_BoostPad *strategy;
};
