...
// Original PDB header: w:\tech5\tungsten\game\entities\bouncesparks.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 20051; PDB kind: struct.
struct idBounceSparks::sparkTimings_t
{
  float minDelay;
  float maxDelay;
};

// IDA Local Type ordinal 20053; PDB kind: class.
class idBounceSparks : public idVolume
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34105.
  ...
  float impulse;
  idList<idBounceSparks::sparkTimings_t,5> sparkTimings;
  int nextSparkTime;
};
