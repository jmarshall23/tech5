...
// Original PDB header: w:\tech5\tungsten\game\entities\tumbleweed.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19023; PDB kind: class.
class __declspec(align(8)) idTumbleWeed : public idDynamicEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19024.
  virtual idTypeInfo *GetType();
  virtual ~idTumbleWeed();
  ...
  idMat3 modelAxis;
  idVec3 velocity;
  idClipQuery moveQuery;
  idDeferredShadow deferredDropShadow;
  idRecycledTraceModel *dropShadowTrm;
};
