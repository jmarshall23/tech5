...
// Original PDB header: w:\tech5\tungsten\game\entities\worldspawn.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1100; PDB kind: enum.
enum idWorldspawn::mapType_t : __int32
{
  MAPTYPE_INSTANCE = 0x0,
  MAPTYPE_OUTDOOR = 0x1,
  MAPTYPE_RACETRACK = 0x2,
  MAPTYPE_TOWN = 0x3,
  MAPTYPE_MERGEMAP = 0x4,
  MAPTYPE_MAX = 0x5,
};

// IDA Local Type ordinal 15626; PDB kind: class.
class __declspec(align(8)) idWorldspawn : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 15627.
  ...
  float gravity;
  float aiSenseScale;
  float aiGunfireRadius;
  float playerAimDistance;
  idList<idStr,5> callList;
  idWorldspawn::mapType_t mapType;
  idList<idStr,5> includedMaps;
  idStr entityPrefix;
  const idDeclEnv *envSettings;
  idList<idDeclLayer const *,5> initialLayers;
  idList<idDeclLayer const *,5> initialDeactiveLayers;
  idList<idStartInventory,5> devmapStartInventory;
  bool devmapGiveAll;
  bool devmapNotarget;
  bool devmapGodMode;
  const idDeclSpecialEvent_Area *areaDecl;
  idList<enum aasType_t,5> aasTypes;
  bool aiUsesCover;
};
