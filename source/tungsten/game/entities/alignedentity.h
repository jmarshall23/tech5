...
// Original PDB header: w:\tech5\tungsten\game\entities\alignedentity.h
// Recovered logical types: 6
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1242; PDB kind: enum.
enum idAlignedEntity::ALIGNMODE : __int32
{
  SET_POS_SET_AXIS = 0x0,
  ALIGN_NODE_POS_SET_AXIS = 0x1,
  ALIGN_NODE_POS_ALIGN_NODE_AXIS = 0x2,
};

// IDA Local Type ordinal 14222; PDB kind: class.
class __declspec(align(8)) idAlignedEntity : public idAnimatedEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 33861.
  ...
  idAlignedEntity::loopingSound_t loopingSound;
  idAnimator_Channel baseAnimator;
  idAnimator_Synced syncedAnimator;
  idAnimator_Synced syncedAnimator2;
  idAnimator_Channel additiveAnimator;
  idAnimator_Synced additiveSyncedAnimator;
  idAlignedEntity::animInfo_t baseAnimInfo;
  idAlignedEntity::animInfo_t additiveAnimInfo;
  idStr alignNodeName;
  bool isAlive;
  idStr soundTagName;
  idAttachmentCollection attachmentCollection;
  idList<idAlignedEntity::addedAttachment_t,5> attachmentInfos;
  bool manualUpdate;
  bool okToShow;
  bool updateCamera;
  idPlayer *owner;
  ...
  idList<idEntityAttachmentDef,5> animatedEntityAttachments;
};

// IDA Local Type ordinal 14223; PDB kind: struct.
struct __declspec(align(4)) idAlignedEntity::loopingSound_t
{
  const idSoundShader *shader;
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> aliasHandle;
};

// IDA Local Type ordinal 14303; PDB kind: struct.
struct idAlignedEntity::queuedAnim_t
{
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> aliasHandle;
  bool loop;
  int durationMS;
...
// IDA Local Type ordinal 14305; PDB kind: struct.
struct idAlignedEntity::animInfo_t
{
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> curAliasHandle;
  int animDurationMS;
  idList<idAlignedEntity::queuedAnim_t,5> queuedAnims;
  bool startBlendOut;
  int startTime;
};

// IDA Local Type ordinal 14310; PDB kind: struct.
struct __declspec(align(4)) idAlignedEntity::addedAttachment_t
{
  const idDeclInventory *attachItemDecl;
  idInventoryItem *attachItem;
  idHandle<int,enum invalidAttachment_t,-1> attachHandle;
  bool attachAutoDetach;
  bool noClone;
};
