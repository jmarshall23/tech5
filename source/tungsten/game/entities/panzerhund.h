...
// Original PDB header: w:\tech5\tungsten\game\entities\panzerhund.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19621; PDB kind: class.
class idPanzerHund : public idAnimated_AnimWeb
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19622.
  virtual idTypeInfo *GetType();
  virtual ~idPanzerHund();
