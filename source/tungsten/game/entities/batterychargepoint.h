...
// Original PDB header: w:\tech5\tungsten\game\entities\batterychargepoint.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 20056; PDB kind: class.
class __declspec(align(8)) idProp_BatteryChargePoint : public idProp_ContinuallyUsed
{
public:
  // Recovered virtual interface; IDA vtable ordinal 20057.
  virtual idTypeInfo *GetType();
  virtual ~idProp_BatteryChargePoint();
  ...
  virtual bool BeforeUse(idEntity *);
