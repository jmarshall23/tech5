...
// Original PDB header: w:\tech5\tungsten\game\entities\scenepoint.h
// Recovered logical types: 11
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1643; PDB kind: enum.
enum __bitmask scenePointType_t : __int32
{
  ROAM = 0x1,
  LOOK = 0x2,
};

// IDA Local Type ordinal 2423; PDB kind: enum.
enum scenePointFlags_t : __int32
{
  SP_NONE = 0x0,
  SP_LOW_PRIO = 0x1,
};

// IDA Local Type ordinal 17229; PDB kind: class.
class __declspec(align(8)) idScenePoint : public idInfo
{
public:
  // Recovered virtual interface; IDA vtable ordinal 17231.
  virtual idTypeInfo *GetType();
  virtual ~idScenePoint();
  ...
  virtual bool IsInArc(const idAIPos *);
  virtual bool IsInArc_2(const idVec3 *);

  idEntityPtr<idScenePoint_UserGroup> userGroup;
  float duration;
  float radius;
  scenePointScriptFlags_t scriptFlags;
  scenePointType_t type;
  const idAI2 *currentUser;
  int requestTime;
  idList<idScenePoint *,5> relatedScenePoints;
};

// IDA Local Type ordinal 19493; PDB kind: class.
class __declspec(align(8)) idScenePoint_Arc : public idScenePoint
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19494.
  virtual idTypeInfo *GetType();
  virtual ~idScenePoint_Arc();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
  ...
  float maxAbove;
  float maxBelow;
  idEntityPtr<idVolume> arcVolume;
};

// IDA Local Type ordinal 19495; PDB kind: struct.
struct idScenePoint_Combat::scenePointCustomSet_t
{
  idAnimWebPath customCoverSet;
  idAnimWebPath hurtAnim;
  idAnimWebPath deathAnim;
};

// IDA Local Type ordinal 19496; PDB kind: struct.
struct idScenePoint_Combat::scenePointEnterAnim_t
{
  bool forced;
  idAnimWebPath enterAnim;
};

// IDA Local Type ordinal 19497; PDB kind: struct.
struct idScenePoint_Combat::scenePointExitAnim_t
{
  idAnimWebPath exitAnim_Timeout;
  idAnimWebPath exitAnim_SectorNear;
  idAnimWebPath exitAnim_SectorLeft;
  idAnimWebPath exitAnim_SectorRight;
  idAnimWebPath exitAnim_SectorFar;
};

// IDA Local Type ordinal 19498; PDB kind: class.
class __declspec(align(8)) idScenePoint_Combat : public idScenePoint_Arc
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19499.
  virtual idTypeInfo *GetType();
  virtual ~idScenePoint_Combat();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
  ...
  idProp_WeaponStatic *scenePointTurret;
  scenePointTacFlags_t tacFlags;
  idScenePoint_Combat::scenePointCustomSet_t customSet;
  idScenePoint_Combat::scenePointEnterAnim_t enterAnimSet;
  idScenePoint_Combat::scenePointExitAnim_t exitAnimSet;
};

// IDA Local Type ordinal 19500; PDB kind: class.
class __declspec(align(8)) idScenePoint_Search : public idScenePoint_Arc
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19501.
  virtual idTypeInfo *GetType();
  virtual ~idScenePoint_Search();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
  ...
  scenePointSearchFlags_t searchFlags;
};

// IDA Local Type ordinal 19502; PDB kind: class.
class __declspec(align(8)) idScenePoint_Look : public idScenePoint_Arc
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19503.
  virtual idTypeInfo *GetType();
  virtual ~idScenePoint_Look();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
...
// IDA Local Type ordinal 19504; PDB kind: class.
class idScenePoint_Roam : public idScenePoint
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19505.
  virtual idTypeInfo *GetType();
  virtual ~idScenePoint_Roam();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
  ...
  idAnimWebPath scenePointAnimation;
};
