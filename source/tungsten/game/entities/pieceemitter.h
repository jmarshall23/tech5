...
// Original PDB header: w:\tech5\tungsten\game\entities\pieceemitter.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 15274; PDB kind: class.
class __declspec(align(8)) idPieceEmitter : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 15275.
  virtual idTypeInfo *GetType();
  virtual ~idPieceEmitter();
