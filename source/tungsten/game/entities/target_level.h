...
// Original PDB header: w:\tech5\tungsten\game\entities\target_level.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19376; PDB kind: class.
class __declspec(align(8)) idTarget_Remove : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19377.
  virtual idTypeInfo *GetType();
  virtual ~idTarget_Remove();
