...
// Original PDB header: w:\tech5\tungsten\game\entities\springentity.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19460; PDB kind: class.
class __declspec(align(8)) idSpringEntity : public idAnimatedEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19461.
  virtual idTypeInfo *GetType();
  virtual ~idSpringEntity();
