...
// Original PDB header: w:\tech5\tungsten\game\entities\door_animated.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19960; PDB kind: class.
...
public:
  ...
  idPresentableDoorAnimated *presentable;
};

// IDA Local Type ordinal 19962; PDB kind: class.
class idDoor_Animated : public idDoor_Base
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19963.
  ...
  idAnimator_Channel doorAnimator;
  int pushFlags;
  idStr openAnim;
  idStr closeAnim;
  idStr lockAnim;
  ...
  bool playing;
  int openCount;
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> openAnimHandle;
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> closeAnimHandle;
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> lockAnimHandle;
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> unlockAnimHandle;
