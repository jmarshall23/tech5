...
// Original PDB header: w:\tech5\tungsten\game\entities\sound.h
// Recovered logical types: 4
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 12096; PDB kind: class.
class CXuiSound : public CXuiElement
{
public:
};

// IDA Local Type ordinal 13495; PDB kind: class.
class idStrSound : public idAtomicString
{
public:
};

// IDA Local Type ordinal 19477; PDB kind: class.
class __declspec(align(8)) idSound : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19478.
  ...
  virtual void ModifyVolume(float, bool);
...
// IDA Local Type ordinal 22702; PDB kind: struct.
struct soundLog_t
{
  int totalEmitterChannels;
  int totalHardwareChannels;
  int activeEmitterChannels;
  int activeHardwareChannels;
  float maxDB;
  float minDB;
  int activeBuffers;
  int freeBuffers;
