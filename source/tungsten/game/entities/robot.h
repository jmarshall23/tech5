...
// Original PDB header: w:\tech5\tungsten\game\entities\robot.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19517; PDB kind: class.
class __declspec(align(8)) idRobot : public idAnimatedEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19518.
  ...
  idStrClipModel traceModel;
  idStrRenderModel lowerBodyModel;
  idStrRenderModel upperBodyModel;
  idList<cockpitSeatInfo_t,5> cockpitSeatInfo;
  controlSettings_t pilotSettings;
  const idDeclWeapon *primaryWeaponDecl;
  const idDeclWeapon *secondaryWeaponDecl;
  idVec3 primaryMuzzleOffset;
  idVec3 secondaryMuzzleOffset;
  float maxHealth;
  float startHealth;
  idWeapon *primaryWeapon;
  idWeapon *secondaryWeapon;
  float currentSpeed;
  float currentTurnSpeed;
  idPhysics_RigidBody physicsObjectRB;
  idPhysics_AF physicsObjectAF;
  idList<cockpitSeatState_t,5> cockpitSeatState;
  idAngles fpsLastViewAngles;
  idAngles fpsCurrViewAngles;
  int fpsLastUpdate;
  idMat3 upperAxis;
  idMat3 lowerAxis;
  idVec3 lowerOrigin;
  idVec3 currentViewPos;
  idMat3 currentViewAxis;
  int primaryFireTime;
  int secondaryFireTime;
  float health;
  idList<idEntityPtr<idEntity>,5> enterTargets;
  idList<idEntityPtr<idEntity>,5> exitTargets;
  idList<idEntityPtr<idEntity>,5> secondaryFireTargets;
  idList<idEntityPtr<idEntity>,5> primaryFireTargets;
};
