...
// Original PDB header: w:\tech5\tungsten\game\entities\breakable.h
// Recovered logical types: 8
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1837; PDB kind: enum.
enum __bitmask idProp_Breakable::breakableState_t : __int32
{
  DAMAGED = 0x1,
  EXPLODING = 0x2,
};

// IDA Local Type ordinal 14544; PDB kind: class.
class idBreakableTrail
{
public:
...
// IDA Local Type ordinal 14547; PDB kind: class.
class __declspec(align(4)) idBreakableDecal
{
public:
  idList<idMaterial const *,59> materials;
  idVec2 minSize;
  idVec2 maxSize;
  int lifetime;
...
// IDA Local Type ordinal 14551; PDB kind: class.
class idBreakableSpark
{
public:
  idList<idMaterial const *,59> materials;
  float sizeMin;
...
// IDA Local Type ordinal 19542; PDB kind: class.
class __declspec(align(8)) idProp_Breakable : public idProp_Moveable
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19543.
  virtual idTypeInfo *GetType();
  virtual ~idProp_Breakable();
  ...
  virtual void RemoveSelf(int);

  idProp_Breakable::breakableState_t state;
  float health;
  bool onlyMeleeDamage;
  const idDeclEntityDef *replacement;
  idList<idDeclEntityDef const *,5> parts;
  idList<idDeclEntityDef const *,5> splinters;
  int minSplinters;
  int maxSplinters;
  const idSoundShader *sound_break;
  float delaySoundAfterBreak;
  float removeDelay;
  const idDeclParticle *smokeParticle;
  bool breakFromTrigger;
  bool explodes;
  const idDeclEntityDef *explosionProjectile;
  const idDeclAiEvent *explosionEventDecl;
  const idDeclDamage *explodeDamage;
  const idDeclEntityDef *breakable;
  const idDeclEntityDef *entityToSpawnOnBreak;
  int smokeStartTime;
  idList<idEntity *,5> spawnParts;
  idList<idEntity *,5> spawnSplinters;
  idEntity *replacementPart;
  int nextCollideTime;
  weaponStatsTag_t statsTag;
  idList<idDeclDamage const *,5> ammoDamage;
  highlightColor_t highlightColor;
};

// IDA Local Type ordinal 19868; PDB kind: struct.
...
// IDA Local Type ordinal 20047; PDB kind: class.
class idBreakable : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 20050.
  virtual idTypeInfo *GetType();
  virtual ~idBreakable();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
...
// IDA Local Type ordinal 23467; PDB kind: struct.
struct breakableIsland_t
{
  int index;
  float lowestPoint;
};
