...
// Original PDB header: w:\tech5\tungsten\game\entities\volume.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 4542; PDB kind: struct.
struct D3DVolume : D3DResource
{
...
// IDA Local Type ordinal 14361; PDB kind: class.
class __declspec(align(8)) idVolume : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34080.
