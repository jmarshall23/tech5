...
// Original PDB header: w:\tech5\tungsten\game\entities\entityemitter.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1928; PDB kind: enum.
enum idEntityEmitter::AXIS : __int32
{
  AXIS_NONE = 0xFFFFFFFF,
};

// IDA Local Type ordinal 19918; PDB kind: class.
class __declspec(align(8)) idEntityEmitter : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19919.
  virtual idTypeInfo *GetType();
  virtual ~idEntityEmitter();
  ...
  idEntityEmitter::AXIS particleAlignmentExcludeAxis;
