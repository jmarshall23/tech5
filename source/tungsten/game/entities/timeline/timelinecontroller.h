...
// Original PDB header: w:\tech5\tungsten\game\entities\timeline\timelinecontroller.h
// Recovered logical types: 5
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19108; PDB kind: struct.
struct __declspec(align(4)) mgTimelineController::tlEvent_t : tlEventData_t
{
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> animHandle;
};

// IDA Local Type ordinal 19110; PDB kind: struct.
struct mgTimelineController::tlTrack_t::grouping_t
{
  int groupId;
  int belongsToId;
};

// IDA Local Type ordinal 19112; PDB kind: struct.
struct mgTimelineController::tlTrack_t
{
  idEntityPtr<idEntity> target;
  idList<mgTimelineController::tlEvent_t,5> events;
  mgTimelineController::tlTrack_t::grouping_t grouping;
  mgTimeSpan timeSpan;
  idAnimator_Channel *animator;
  idAnimator_FaceTracks *faceAnimator;
  idVec3 pos;
};

// IDA Local Type ordinal 19114; PDB kind: class.
class mgTimelineController : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19115.
  virtual idTypeInfo *GetType();
  virtual ~mgTimelineController();
  ...
  idList<mgTimelineController::tlTrack_t,5> tracks;
  mgTimeSpan timeSpan;
  bool initDone;
  bool timeLeap;
  int startTime;
...
// IDA Local Type ordinal 19116; PDB kind: struct.
struct mgTimelineController::runContext_t
{
  const mgTimelineController::tlTrack_t *track;
  const mgTimelineController::tlEvent_t *event;
  idEntity *entity;
  idPlayer *player;
  int deltaTime;
  int eventTime;
