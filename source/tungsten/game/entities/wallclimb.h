...
// Original PDB header: w:\tech5\tungsten\game\entities\wallclimb.h
// Recovered logical types: 3
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1238; PDB kind: enum.
enum idWallClimb::wallClimbEndPointType_t : __int32
{
  WALLCLIMB_ENDPOINT_NONE = 0x0,
  WALLCLIMB_ENDPOINT_UP = 0x1,
  WALLCLIMB_ENDPOINT_DOWN = 0x2,
};

// IDA Local Type ordinal 17959; PDB kind: class.
class idWallClimb : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 17960.
  ...
  idEntityPtr<idEntity> anchorPoint;
  idEntityPtr<idEntity> climbOffTarget;
  float maxMoveAngle;
  float sidewaysSpeed;
  float maxDeltaYaw;
  float maxDeltaPitch;
  idList<idEntityPtr<idEntity>,5> climbOffTriggers;
  idVec3 direction;
  float tanMaxMoveAngle;
};

// IDA Local Type ordinal 18871; PDB kind: class.
class __declspec(align(8)) idUseWallClimb : public idUse
{
public:
  // Recovered virtual interface; IDA vtable ordinal 18872.
  virtual idTypeInfo *GetType();
  virtual ~idUseWallClimb();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
