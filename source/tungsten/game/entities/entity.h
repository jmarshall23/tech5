...
// Original PDB header: w:\tech5\tungsten\game\entities\entity.h
// Recovered logical types: 5
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 2843; PDB kind: unknown.
enum idEntity::<unnamed_tag> : __int32
{
  EVENT_STARTSOUNDSHADER = 0x0,
  EVENT_STOPSOUNDSHADER = 0x1,
  EVENT_MAXEVENTS = 0x2,
};

// IDA Local Type ordinal 14219; PDB kind: class.
class __declspec(align(8)) idEntity : public idEventReceiver
{
public:
  // Recovered virtual interface; IDA vtable ordinal 15187.
  ...
  idRenderModelInfo renderModelInfo;
  idClipModelInfo clipModelInfo;
  idEntity::idBindInfo bindInfo;
  idEntity::idDormancy dormancy;
  ...
  idPhysics *physics;
  idGatherQuery touchTriggersQuery;
  int numPVSAreas;
  int PVSAreas[4];
  ...
  idList<idSSObject *,5> superScriptObjects;
  idLinkList<idEntity> spawnNode;
  idLinkList<idEntity> activeNode;
  idLinkList<idEntity> removeNode;
};

// IDA Local Type ordinal 15172; PDB kind: struct.
struct idEntity::entityFlags_t
{
  __int8 selected : 1;
  __int8 takedamage : 1;
  __int8 noknockback : 1;
  __int8 isActivatable : 1;
  __int8 noFlood : 1;
  __int8 forcePhysicsUpdate : 1;
  __int8 canBecomeDormant : 1;
  __int8 hide : 1;
  __int8 dynamicClipReplicationAxis : 1;
  __int8 dynamicClipReplication : 1;
  __int8 skipReplication : 1;
  __int8 afTouchesTriggers : 1;
  __int8 touchesTriggers : 1;
  __int8 enableStaticSpecular : 1;
  __int8 noSightStimulus : 1;
  __int8 isDormant : 1;
  unsigned __int8 : 7;
  __int8 isAimAssistTarget : 1;
};

// IDA Local Type ordinal 15175; PDB kind: class.
class idEntity::idBindInfo
{
public:
  idEntityPtr<idEntity> bindParent;
  idAngles bindOffset;
  idStr bindToJoint;
  idStr bindToTag;
  idStr bindAnim;
  unsigned __int8 : 4;
  __int8 snapToParent : 1;
  __int8 solidForTeam : 1;
  __int8 bindLighting : 1;
  __int8 bindOrientated : 1;
  idEntity *bindMaster;
  idEntity *teamMaster;
  idEntity *teamChain;
  idIndex<short,enum invalidJointIndex_t> bindJoint;
  tagData_t bindTag;
};

// IDA Local Type ordinal 15176; PDB kind: class.
class __declspec(align(4)) idEntity::idDormancy
{
public:
  float delay;
  float distance;
  int lastTimeInPlayerPVS;
  int becomeDormantTime;
  int endForceTime;
  bool forceDormant;
};
