...
// Original PDB header: w:\tech5\tungsten\game\entities\collisionstreamarea.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19991; PDB kind: class.
class __declspec(align(8)) idCollisionStreamArea : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19992.
