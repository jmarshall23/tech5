...
// Original PDB header: w:\tech5\tungsten\game\entities\actionnode.h
// Recovered logical types: 4
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 17031; PDB kind: class.
class idAction_Dodge : public idAIAction
{
public:
  // Recovered virtual interface; IDA vtable ordinal 33741.
  virtual idTypeInfo *GetType();
  virtual ~idAction_Dodge();
...
// IDA Local Type ordinal 19407; PDB kind: class.
class __declspec(align(8)) idTarget_ActionNode : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19408.
  virtual idTypeInfo *GetType();
  virtual ~idTarget_ActionNode();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
  ...
  idEntityPtr<idActionNode> actionNode;
};

// IDA Local Type ordinal 20105; PDB kind: struct.
struct idActionNode::anim_t
{
...
// IDA Local Type ordinal 20107; PDB kind: class.
class __declspec(align(8)) idActionNode : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 20108.
  virtual idTypeInfo *GetType();
  ...
  sitState_t sitState;
  posture_t posture;
  idList<idActionNode::anim_t,5> anims;
  aasType_t aasType;
  bool shouldCheckAAS;
