...
// Original PDB header: w:\tech5\tungsten\game\animation\managedchannelanimator.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 21923; PDB kind: struct.
struct idManagedChannelAnimator::queuedAnim_t
{
  idHandle<unsigned short,enum invalidAliasHandle_t,65535> animAlias;
  bool loop;
  float targetAlpha;
  float alphaRate;
  int durationMS;
...
// IDA Local Type ordinal 21925; PDB kind: class.
class idManagedChannelAnimator : public idAnimator_Channel
{
public:
  // Recovered virtual interface; IDA vtable ordinal 21926.
  virtual ~idManagedChannelAnimator();
  ...
  int animEndTimeMS;
  idList<idManagedChannelAnimator::queuedAnim_t,5> queuedAnims;
  bool startBlendOut;
  int startTime;
};
