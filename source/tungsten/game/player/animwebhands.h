...
// Original PDB header: w:\tech5\tungsten\game\player\animwebhands.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 15368; PDB kind: class.
class idAnimWebHands : public idAnimator_AnimWebHands
{
public:
  // Recovered virtual interface; IDA vtable ordinal 15370.
  virtual ~idAnimWebHands();
  ...
  virtual void InternalUpdateTriggerEvent(const idDeclAnimWebNode *, const animWebEvent_t);

  idHands *hands;
};

// IDA Local Type ordinal 33122; PDB kind: typedef.
typedef idHandle<short,enum invalidAnimWebHandle_t,-1> animWebHandle_t;
