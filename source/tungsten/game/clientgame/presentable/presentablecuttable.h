...
// Original PDB header: w:\tech5\tungsten\game\clientgame\presentable\presentablecuttable.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 20322; PDB kind: class.
class idPresentableCuttable : public idPresentable
{
public:
  // Recovered virtual interface; IDA vtable ordinal 20323.
  virtual ~idPresentableCuttable();
