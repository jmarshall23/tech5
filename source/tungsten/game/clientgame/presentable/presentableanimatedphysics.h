...
// Original PDB header: w:\tech5\tungsten\game\clientgame\presentable\presentableanimatedphysics.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 20070; PDB kind: class.
class __declspec(align(4)) idPresentableAnimatedPhysics : public idPresentable
{
public:
  // Recovered virtual interface; IDA vtable ordinal 20071.
  virtual ~idPresentableAnimatedPhysics();
