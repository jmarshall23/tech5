...
// Original PDB header: w:\tech5\tungsten\game\clientgame\presentable\presentableturret.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 15503; PDB kind: class.
class __declspec(align(4)) idPresentableTurret : public idPresentableWeapon
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34121.
  virtual ~idPresentableTurret();
  ...
  __int16 jointRotationYaw;
  __int16 clientLastUpdateRotationYaw;
  __int16 jointRotationPitch;
  __int16 clientLastUpdateRotationPitch;
  idIndex<short,enum invalidJointIndex_t> jointPitch;
  __int16 jointPitchPitch;
  __int16 clientLastUpdatejointPitch;
