...
// Original PDB header: w:\tech5\tungsten\game\clientgame\presentable\presentablearmorpiece.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 15485; PDB kind: class.
class __declspec(align(8)) idPresentableArmorPiece : public idPresentable
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34005.
  virtual ~idPresentableArmorPiece();
