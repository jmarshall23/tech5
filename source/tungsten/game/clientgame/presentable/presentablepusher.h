...
// Original PDB header: w:\tech5\tungsten\game\clientgame\presentable\presentablepusher.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 15502; PDB kind: class.
class __declspec(align(8)) idPresentablePusher : public idPresentable
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34016.
  virtual ~idPresentablePusher();
