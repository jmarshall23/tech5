...
// Original PDB header: w:\tech5\tungsten\game\clientgame\presentable\presentableeboltemitter.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 20320; PDB kind: class.
class __declspec(align(8)) idPresentableEBoltEmitter : public idPresentable
{
public:
  // Recovered virtual interface; IDA vtable ordinal 20321.
  virtual ~idPresentableEBoltEmitter();
