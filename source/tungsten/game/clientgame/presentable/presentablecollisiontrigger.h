...
// Original PDB header: w:\tech5\tungsten\game\clientgame\presentable\presentablecollisiontrigger.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 15505; PDB kind: class.
class __declspec(align(4)) idPresentableCollisionTrigger : public idPresentable
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34007.
  virtual ~idPresentableCollisionTrigger();
  ...
  idPresentablePtr<idPresentable> targetPresentable;
  bool triggered;
};
