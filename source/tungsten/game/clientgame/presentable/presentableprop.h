...
// Original PDB header: w:\tech5\tungsten\game\clientgame\presentable\presentableprop.h
// Recovered logical types: 4
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 2129; PDB kind: enum.
enum idPresentableProp::specialProp_t : __int32
{
  SPECIAL_PROP_NONE = 0x0,
  SPECIAL_PROP_RALLY = 0x1,
};

// IDA Local Type ordinal 5330; PDB kind: struct.
...
// IDA Local Type ordinal 15442; PDB kind: struct.
struct idPresentableProp::pickupEventInfo_t
{
  int eventTime;
...
// IDA Local Type ordinal 15443; PDB kind: class.
class __declspec(align(8)) idPresentableProp : public idPresentableAnimatedEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34015.
  virtual ~idPresentableProp();
  ...
  idPresentableProp::pickupEventInfo_t pickupEventInfo;
  ...
  idPresentableProp::specialProp_t specialType;
};
