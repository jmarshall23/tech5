...
// Original PDB header: w:\tech5\tungsten\game\ai\aiscriptedanimweb.h
// Recovered logical types: 7
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 1771; PDB kind: enum.
enum idAIScriptedAnimWeb::stateMarker_t : __int32
{
  STATE_EXIT = 0xFFFFFFFD,
};

// IDA Local Type ordinal 2273; PDB kind: enum.
enum idAIScriptedAnimWeb::loopTriggerType_t : __int32
{
  TRIGGERTYPE_ONCOUNT = 0x0,
  TRIGGERTYPE_EVERYCOUNT = 0x1,
};

// IDA Local Type ordinal 17095; PDB kind: struct.
struct __declspec(align(4)) idAIScriptedAnimWeb::animWebState_t
{
  idAnimWebPath destAnimRef;
  idAnimWebPath viaAnimRef;
  idAnimWebPath exitFastRef;
  ...
  idAIScriptedAnimWeb::loopTriggerType_t loopTriggerType;
  __int8 setPerceptionFlagsOnExit : 1;
  __int8 clearPerceptionFlagsOnExit : 1;
  __int8 releaseAI : 1;
  __int8 perfectOrigin : 1;
  __int8 loop : 1;
  __int8 disableSolid : 1;
  __int8 disableWorldCollsion : 1;
  __int8 disableIK : 1;
  unsigned __int8 : 4;
  __int8 useAnimationOrigin : 1;
  __int8 forceTransition : 1;
  __int8 enableHeadTracking : 1;
  __int8 keepIKState : 1;
};

// IDA Local Type ordinal 17097; PDB kind: struct.
struct idAIScriptedAnimWeb::animState_t
{
  idList<idAIScriptedAnimWeb::animWebState_t,5> *animWebStates;
  int currentState;
};

// IDA Local Type ordinal 17098; PDB kind: class.
class __declspec(align(2)) idAction_ScriptedAnimWeb : public idAIAction
{
public:
  // Recovered virtual interface; IDA vtable ordinal 33786.
  virtual idTypeInfo *GetType();
  virtual ~idAction_ScriptedAnimWeb();
  ...
  idAIScriptedAnimWeb::animState_t *stateInfo;
  int currentScriptState;
  int currentLoopCount;
  int loopInterval;
  int stateStartTime;
  idIndex<short,enum idDeclAnimWeb::invalidSubWebIndex_t> currentSubWebTarget;
  idIndex<short,enum idDeclAnimWeb::invalidStateIndex_t> currentStateTarget;
  idVec3 nextTargetPosition;
  idQuat nextTargetRotation;
  aiMovementMode_t movementMode;
  unsigned __int8 : 5;
  __int8 keepIKState : 1;
  __int8 wasIKEnabled : 1;
  __int8 isDone : 1;
  bool wasHeadTrackingEnabled;
  bool wasSolid;
};

// IDA Local Type ordinal 21355; PDB kind: class.
class ScriptedAnimWebDone : public idAIStateTransitionStatic
{
public:
  // Recovered virtual interface; IDA vtable ordinal 21356.
  virtual idTypeInfo *GetType();
  virtual ~ScriptedAnimWebDone();
...
// IDA Local Type ordinal 21411; PDB kind: class.
class idAIScriptedAnimWeb : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 21412.
  virtual idTypeInfo *GetType();
  virtual ~idAIScriptedAnimWeb();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
