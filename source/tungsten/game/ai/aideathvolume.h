...
// Original PDB header: w:\tech5\tungsten\game\ai\aideathvolume.h
// Recovered logical types: 1
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 21498; PDB kind: class.
class __declspec(align(8)) idAIDeathVolume : public idVolume
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34104.
