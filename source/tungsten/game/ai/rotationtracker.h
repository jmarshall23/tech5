...
// Original PDB header: w:\tech5\tungsten\game\ai\rotationtracker.h
// Recovered logical types: 3
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 16723; PDB kind: class.
class __declspec(align(2)) idRotationTracker
{
public:
  // Recovered virtual interface; IDA vtable ordinal 16724.
  virtual ~idRotationTracker();
  virtual void Update(const idVec3 *, const idMat3 *, const idVec3 *, const float, const bool, const int);

  idQuat rot;
  idTypesafeNumber<float,enum RadiansUnique_t> maxPitch;
  idTypesafeNumber<float,enum RadiansUnique_t> maxYaw;
  float maxPitchDot;
  float maxYawDot;
  float halfMaxPitchDot;
  float halfMaxYawDot;
  idTypesafeNumber<float,enum RadiansUnique_t> maxVelocity;
  idTypesafeNumber<float,enum RadiansUnique_t> velocity;
  idTypesafeNumber<float,enum RadiansUnique_t> acceleration;
  idTypesafeNumber<float,enum RadiansUnique_t> deceleration;
  bool projectWhenBehind;
  bool clampedYaw;
  bool clampedPitch;
};

// IDA Local Type ordinal 19158; PDB kind: class.
class idTest_RotationTracker : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19159.
  virtual idTypeInfo *GetType();
  virtual ~idTest_RotationTracker();
...
// IDA Local Type ordinal 20494; PDB kind: class.
