...
// Original PDB header: w:\tech5\tungsten\game\ai\aiinteraction.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 19036; PDB kind: class.
class idTrigger_AIInteraction : public idTrigger
{
public:
  // Recovered virtual interface; IDA vtable ordinal 19037.
  virtual idTypeInfo *GetType();
  virtual ~idTrigger_AIInteraction();
...
// IDA Local Type ordinal 21413; PDB kind: class.
class idAIInteraction : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 21414.
  virtual idTypeInfo *GetType();
  virtual ~idAIInteraction();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
