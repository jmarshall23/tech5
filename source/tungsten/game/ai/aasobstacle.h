...
// Original PDB header: w:\tech5\tungsten\game\ai\aasobstacle.h
// Recovered logical types: 4
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 20462; PDB kind: struct.
...
// IDA Local Type ordinal 21516; PDB kind: class.
class __declspec(align(8)) idAASObstacle : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 21517.
  virtual idTypeInfo *GetType();
  virtual ~idAASObstacle();
...
// IDA Local Type ordinal 23521; PDB kind: struct.
const struct idAAS2Obstacle
{
  idBounds absBounds;
  idBounds expAbsBounds;
};

// IDA Local Type ordinal 32576; PDB kind: typedef.
typedef unsigned __int8 aas2ObstaclePVS_t;
