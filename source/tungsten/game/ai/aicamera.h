...
// Original PDB header: w:\tech5\tungsten\game\ai\aicamera.h
// Recovered logical types: 4
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 14501; PDB kind: class.
class __declspec(align(8)) idCamera : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 33877.
...
// IDA Local Type ordinal 18657; PDB kind: class.
class idAIDebugCamera : public idEntityCamera
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34161.
  virtual idTypeInfo *GetType();
  virtual ~idAIDebugCamera();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
  ...
  virtual bool InternalActivate(idEntity *);
  virtual bool InternalDeactivate();
  virtual idEntity *GetTargetEntity();
  virtual void SetTargetEntity(idEntity *);
  virtual void GetTargetPos(idVec3 *);
  virtual void SetTargetPos(const idVec3 *);
  virtual float GetDistance();
  virtual void SetDistance(float);
  virtual void GetOffset(idVec3 *);
  virtual void SetOffset(const idVec3 *);
  virtual const idAngles *GetAngles();
  virtual void SetAngles(const idAngles *);
  virtual void CalculateViewParms();

};

// IDA Local Type ordinal 18922; PDB kind: class.
class __declspec(align(8)) idTrailerCamera : public idEntityCamera
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34134.
  virtual idTypeInfo *GetType();
  virtual ~idTrailerCamera();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
...
// IDA Local Type ordinal 18941; PDB kind: class.
class __declspec(align(8)) idRaceCamera : public idCameraView
{
public:
  // Recovered virtual interface; IDA vtable ordinal 34124.
  virtual idTypeInfo *GetType();
  virtual ~idRaceCamera();
  virtual idEventArg *CallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool RespondsTo(const idEventDef *);
  virtual idEventArg *InternalCallEvent(idEventArg *result, const idEventDef *, const idEventArg *);
  virtual bool InternalRespondsTo(const idEventDef *);
  ...
  int cameraNoObstructionTime;
  int repositionTime;
  int fadeInTime;
  int fadeOutTime;
  idNavSplinePosition navSplinePos;
  idVec3 goalPos;
  idSWF *gui;
};
