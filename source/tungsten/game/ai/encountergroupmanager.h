...
// Original PDB header: w:\tech5\tungsten\game\ai\encountergroupmanager.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 17269; PDB kind: class.
class __declspec(align(4)) idEncounterGroupManager : public idClass
{
public:
  // Recovered virtual interface; IDA vtable ordinal 17270.
  virtual idTypeInfo *GetType();
  virtual ~idEncounterGroupManager();

  idList<idEncounterGroup,5> groups;
  int nextThinkTime;
  idHashIndex hashIndex;
  __int16 curHandle;
};

// IDA Local Type ordinal 21371; PDB kind: class.
class idEncounterGroupMgr : public idEntity
{
public:
  // Recovered virtual interface; IDA vtable ordinal 21372.
  virtual idTypeInfo *GetType();
  virtual ~idEncounterGroupMgr();
