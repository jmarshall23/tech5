...
// Original PDB header: w:\tech5\tungsten\superscript\generated\maps\user\dyoung\dy_world.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 13868; PDB kind: class.
class dy_world : public idSuperScriptObject
{
public:
  // Recovered virtual interface; IDA vtable ordinal 13869.
  virtual void Init();
  ...
  idSoundShader *testSoundDecl;
  idDeclEntityDef *speakerDecl;
  idDeclEntityDef *infoDecl;
  idMaterial *hudImage1;
  int REBUILD;
};

// IDA Local Type ordinal 30243; PDB kind: typedef.
