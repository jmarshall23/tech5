...
// Original PDB header: w:\tech5\tungsten\superscript\generated\maps\user\phook\phook_test.h
// Recovered logical types: 2
// Signatures retain Xbox 360 ABI evidence and may still require manual review.


// IDA Local Type ordinal 13990; PDB kind: class.
class phook_test1 : public idSuperScriptObject
{
public:
  // Recovered virtual interface; IDA vtable ordinal 13991.
  virtual void Init();
...
// IDA Local Type ordinal 13992; PDB kind: struct.
struct phook_test1::simpleStruct_t
{
  int value;
};
